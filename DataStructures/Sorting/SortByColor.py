...
class Solution:
    ...
    def sortColors(self, A):
        start = 0  # values pointing to Zero
        mid = 0  # values pointing to One
        end = len(A) - 1  # values pointing to Two
...
#
# Approach 1:-
# Count the number of red, white, and blue balls. Then, in another pass, set the initial redCount number of cells as
