...
# In a Fibonacci series, each term is the sum of the previous two terms and the first two terms of the series are 0
# and 1. i.e. f(0) = 0 and f(1) = 1. Hence, f(2) = 1, f(3) = 2, f(4) = 3 and so on.
#
...
#
# Approach 1:
#  simple approach is to use the recursive implementation of the recursive relation given.
#
...
#
# To avoid this, try to store the term which is calculated once and before calculating any other term check if it is
